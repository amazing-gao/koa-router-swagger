...
let views = require('koa-views-swagger');
...
swagger.prototype.apiExplorer = function() {
  if (process.env.NODE_ENV === 'production' && this.noApiExplorerOnline)
  ...
  return mount(this.apiExplorerPath, async (ctx) => {
    const options = {
      versioning: this.versioning,
      apiDoc: pathUtil.basename(this.apiDoc),
